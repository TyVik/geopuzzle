...
class Workshop extends React.Component {
  constructor(props) {
    super(props);
    this.orderOptions = window.__ORDER__.map((item) => {
      ...
      <form className="row justify-content-between">
        ...
        <div className="form-group col-md-5 col-sm-12">
          ...
          <Select
            ...
            onChange={(event) => this.onChange("order", event)}
          />
        </div>
        <div className="form-group col-md-6 col-sm-12">
          ...
          <AsyncSelect
            ...
            loadOptions={(inputValue, callback) =>
              this.loadOptions("tag", inputValue, callback)
            }
        ...
        <div className="form-group col-md-6 col-sm-12">
          ...
          <AsyncSelect
            ...
            isClearable
            loadOptions={(inputValue, callback) =>
              this.loadOptions("user", inputValue, callback)
            }
