...
global.REGIONS = [{
  draggable: false, id: 5054, isOpen: true,
  infobox: {
    area: "32,300", capital: {lat: 52, lng: 23, name: "Брест", wiki: "https://ru.wikipedia.org/wiki/Брест"},
  ...
  draggable: false, isOpen: true, id: 5060, infobox: {loaded: false, name: "Витебская область"}, isSolved: false, paths: []
}, {
  draggable: true, isOpen: false, id: 5055, infobox: {loaded: false, name: "Гомельская область"}, isSolved: false, paths: []
}];
