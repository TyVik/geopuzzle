# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-05-06 03:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('options', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('name', 'name'), ('capital', 'capital'), ('flag', 'flag'), ('coat_of_arms', 'coat_of_arms')], max_length=12), size=None)),
